...
@endif
<div class="container px-20 py-32 mx-auto flex items-center justify-center h-screen">
    <div class="items-center lg:flex">
        <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                <h1 class="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">Even<span class="text-blue-500 ">To</span></h1>
